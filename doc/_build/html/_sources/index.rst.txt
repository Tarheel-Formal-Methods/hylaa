.. hylaa documentation master file, created by
   sphinx-quickstart on Mon Dec 16 22:36:24 2019.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to Hylaa's documentation!
=================================
...
.. image:: hylaa_logo_small.png
  :align: center

Introduction to Hylaa
=====================
...
The is version two of Hylaa, with support for resets and hybrid automata with time-varying inputs. The focus has shifted from performance to handling more general dynamics.
